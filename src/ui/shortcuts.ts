export type ShortcutAction =
  "undo" | "redo" | "selectAll" | "copy" | "paste" | "duplicate" | "delete" | "deselect";
...
export function keyboardEventSignature(
...
export function loadShortcuts(): ShortcutMap {
  try {
    return {
      ...DEFAULT_SHORTCUTS,
      ...(JSON.parse(localStorage.getItem(STORAGE_KEY) ?? "{}") as Partial<ShortcutMap>),
    };
  } catch {
